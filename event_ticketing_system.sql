...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2025 at 09:12 PM
...
(4, '2025_02_14_113458_create_events_table', 1),
(5, '2025_02_14_170131_create_event_bookings_table', 1);
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `users_email_hash_unique` (`email_hash`) USING HASH,
  ADD UNIQUE KEY `users_phone_hash_unique` (`phone_hash`) USING HASH;
